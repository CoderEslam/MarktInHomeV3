...
public class ImageViewHolder extends BaseViewHolder {
    ...
    public void ShowImage(Chat chat, int position) {
        ...
        if (!chat.getUri().toString().equals("")) {
            ...
            Log.e("filetoURI()", Uri.parse(MediaStore.Images.Media.getContentUri(chat.getUri()).toString()).toString());
            Log.e("getCurser", getRealPathFromUri(itemView.getContext(), Uri.parse(chat.getUri())));
            Glide.with(itemView.getContext()).load(getRealPathFromUri(itemView.getContext(), Uri.parse(chat.getUri()))).into(imageView);
