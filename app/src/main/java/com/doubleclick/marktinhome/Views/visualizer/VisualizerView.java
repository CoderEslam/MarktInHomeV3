...
public class VisualizerView extends View {
    ...
    private static final float SEGMENT_SIZE = 30.f;
    ...
    private static final float MIN_SIZE_DEFAULT = 5;
    ...
    private static final float RADIUS_BASS = 10 / 50.f;
    ...
    public void setColor(int color1, int color2, int color3) {
        ...
        shapeColor = ContextCompat.getColor(getContext(), color1);
        trailColor = ContextCompat.getColor(getContext(), color2);
        backgroundColor = ContextCompat.getColor(getContext(), color3);
