...
public class FloatingBubbleConfig {
    ...
    private ArrayList<Chat> arrayListChats;
    ...
    private FloatingBubbleConfig(Builder builder) {
        ...
        arrayListChats = builder.arrayListChats;
    ...
    public static Builder getDefaultBuilder(Context context) {
        return new Builder()
                // image as default
                .bubbleIcon("https://firebasestorage.googleapis.com/v0/b/marketinhome-99d25.appspot.com/o/Uploads%2F1654787192896.jpg?alt=media&token=233128c1-7bb9-4647-a380-50004a1bc736")
    ...
    public static final class Builder {
        ...
        public Builder bubbleIcon(String image) {
            bubbleIcon = image;
            return this;
        }
        ...
        public Builder setArrayListChat(ArrayList<Chat> chats){
            arrayListChats = chats;
            return this;
        }
