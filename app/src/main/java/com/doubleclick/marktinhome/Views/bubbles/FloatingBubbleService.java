...
public class FloatingBubbleService extends Service {
    ...
    protected void setupViews() {
        ...
        if (config.getBubbleIcon() != null) {
            ImageView image = ((ImageView) bubbleView.findViewById(R.id.bubble_background));
            Glide.with(BaseApplication.context).load(config.getBubbleIcon()).into(image);
        }
...
//            Log.e("CHATSSSS", config.getChats().toString());
    ...
    protected void restoreBubbleIcon() {
        final ImageView bubbleBackground = bubbleView.findViewById(R.id.bubble_background);
        Glide.with(BaseApplication.context).load(config.getBubbleIcon()).into(bubbleBackground);
    }
